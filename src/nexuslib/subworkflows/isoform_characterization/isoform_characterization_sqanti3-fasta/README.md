## isoform_characterization_sqanti3-fastq.nf
...
```
nexus run --nf-workflow isoform_characterization_sqanti3-fastq.nf \
...
usage: nexus run --nf-workflow isoform_characterization_sqanti3-fastq.nf [required] [optional] [--help]
