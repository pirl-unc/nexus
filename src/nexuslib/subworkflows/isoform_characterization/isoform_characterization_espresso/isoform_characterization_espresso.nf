...
workflow {
    ...
    def params_espresso_s = (params.params_espresso_s == true) ? '' : params.params_espresso_s
    def params_espresso_c = (params.params_espresso_c == true) ? '' : params.params_espresso_c
    def params_espresso_q = (params.params_espresso_q == true) ? '' : params.params_espresso_q
