...
// ------------------------------------------------------------
include { runHLAminerLongReadDNA }   from '../../../tools/hlaminer'
...
params.params_hlaminer      = '-s 500 -q 1 -i 1'

// ------------------------------------------------------------
// Step 3. Sub-workflows
// ------------------------------------------------------------
workflow HLA_TYPING_HLAMINER_LR_DNA {
    take:
...
workflow {
    log.info """\
             ==================================================================
             Profile HLA alleles from long-read DNA FASTQ files using
             HLAminer (minimap2 alignment against HLAminer's genomic reference)
             ==================================================================
             """.stripIndent()
    ...
    if (params.help) {
        log.info"""\
        workflow:
            1. Align long-read DNA FASTQ files against HLAminer's genomic HLA
               reference (HLA-I_II_GEN.fasta) using minimap2.
            2. Pipe the alignment SAM straight into HLAminer.pl to predict HLA
               class I and II alleles.

        usage: nexus run --nf-workflow hla_typing_hlaminer-lr-dna.nf [required] [optional] [--help]
