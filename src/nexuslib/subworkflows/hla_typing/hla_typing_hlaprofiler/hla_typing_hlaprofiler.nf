...
// ------------------------------------------------------------
include { runHLAProfilerPredict }   from '../../../tools/hlaprofiler'
...
// ------------------------------------------------------------
workflow HLA_TYPING_HLAPROFILER {
    take:
...
workflow {
    ...
    if (params.help) {
        ...
        usage: nexus run --nf-workflow hla_typing_hlaprofiler.nf [required] [optional] [--help]
