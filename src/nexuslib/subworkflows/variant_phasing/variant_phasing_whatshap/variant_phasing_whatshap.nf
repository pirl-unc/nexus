...
// ------------------------------------------------------------
workflow VARIANT_PHASING_WHATSHAP {
    take:
...
workflow {
    ...
    if (params.help) {
        ...
        usage: nexus run --nf-workflow variant_phasing_whatshap.nf [required] [optional] [--help]
    ...
    def params_whatshap = (params.params_whatshap == true) ? '' : params.params_whatshap

    log.info"""\
        samples_tsv_file                    :   ${params.samples_tsv_file}
        output_dir                          :   ${params.output_dir}
        reference_genome_fasta_file         :   ${params.reference_genome_fasta_file}
        params_whatshap                     :   ${params_whatshap}
    """.stripIndent()
