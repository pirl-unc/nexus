...
include { runDelly2ShortReadSomatic }       from '../../../tools/delly2'
...
if (params.help) {
    ...
    usage: nexus run --nf-workflow variant_calling_delly2-sr-somatic.nf [required] [optional] [--help]
...
// ------------------------------------------------------------
workflow VARIANT_CALLING_DELLY2_SHORTREAD_SOMATIC {
    take:
    ...
    emit:
        runDelly2ShortReadSomatic.out.f
}
