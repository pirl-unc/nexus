...
if (params.params_reditools2 == true) {
    params_reditools2 = ''
} else {
    params_reditools2 = params.params_reditools2
}

if (params.params_reditools_annotatetable == true) {
    params_reditools_annotatetable = ''
} else {
    params_reditools_annotatetable = params.params_reditools_annotatetable
}
