...
include { runBwaIndex }             from '../../../tools/bwa'
include { runSvaba }                from '../../../tools/svaba'
...
// ------------------------------------------------------------
workflow VARIANT_CALLING_SVABA {
    take:
    ...
    main:
        ...
        runBwaIndex(runSamtoolsFaidx.out.fasta)
        ...
        fasta_amb_file      = runBwaIndex.out.amb_file
        fasta_ann_file      = runBwaIndex.out.ann_file
        fasta_bwt_file      = runBwaIndex.out.bwt_file
        fasta_pac_file      = runBwaIndex.out.pac_file
        fasta_sa_file      = runBwaIndex.out.sa_file
...
workflow {
    ...
    def params_svaba = (params.params_svaba == true) ? '' : params.params_svaba
