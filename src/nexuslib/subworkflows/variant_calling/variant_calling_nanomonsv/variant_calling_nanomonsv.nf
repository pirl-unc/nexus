...
include { runNanomonsv }        from '../../../tools/nanomonsv'
...
// ------------------------------------------------------------
workflow VARIANT_CALLING_NANOMONSV {
    take:
...
workflow {
    ...
    if (params.help) {
        ...
        usage: nexus run --nf-workflow variant_calling_nanomonsv.nf [required] [optional] [--help]
        ...
        optional arguments:
            ...
            --params_nanomonsv_get              :   Nanomonsv get parameters
                                                    (default: '"--min_tumor_variant_read_num 3 --min_tumor_VAF 0.05 --max_control_variant_read_num 0 --max_control_VAF 0.00 --min_indel_size 30 --max_panel_read_num 0 --median_mapQ_thres 20 --qv25"').
                                                    Note that the parameters need to be wrapped in quotes.
        """.stripIndent()
        exit 0
    }

    def params_nanomonsv_parse = (params.params_nanomonsv_parse == true) ? '' : params.params_nanomonsv_parse
    def params_nanomonsv_get   = (params.params_nanomonsv_get == true) ? '' : params.params_nanomonsv_get
