...
include { runStrelka2SomaticMode }  from '../../../tools/strelka2'
...
// ------------------------------------------------------------
workflow VARIANT_CALLING_STRELKA2_SOMATIC {
    take:
...
workflow {
    ...
    if (params.help) {
        ...
        usage: nexus run --nf-workflow variant_calling_strelka2-somatic.nf [required] [optional] [--help]
    ...
    def params_strelka2 = (params.params_strelka2 == true) ? '' : params.params_strelka2
