...
include { runFlair3Align }                          from '../../../tools/flair3'
...
// ------------------------------------------------------------
workflow HAPLOTAGGING_FLAIR3_LONGSHOT {
    take:
    ...
    main:
        ...
        // Step 3. Run LongShot
        // runFlair3Align emits (sample_id, bam, bam.bai, bed); drop the bed for longshot input
        longshot_input_ch = runFlair3Align.out.f
...
workflow {
    log.info """\
             ==================================================================
             Haplotype long-read DNA sequencing BAM files using Flair3+Longshot
             ==================================================================
             """.stripIndent()
    ...
    if (params.help) {
        ...
        usage: nexus run --nf-workflow haplotagging_flair3-longshot.nf [required] [optional] [--help]
