...
workflow {
    ...
    def params_kallisto_bus      = (params.params_kallisto_bus == true) ? '' : params.params_kallisto_bus
    def params_bustools_sort     = (params.params_bustools_sort == true) ? '' : params.params_bustools_sort
    def params_bustools_count    = (params.params_bustools_count == true) ? '' : params.params_bustools_count
    def params_kallisto_quanttcc = (params.params_kallisto_quanttcc == true) ? '' : params.params_kallisto_quanttcc
