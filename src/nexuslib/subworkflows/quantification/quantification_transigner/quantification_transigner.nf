...
workflow {
    ...
    def params_transigner_align     = (params.params_transigner_align == true) ? '' : params.params_transigner_align
    def params_transigner_prefilter = (params.params_transigner_prefilter == true) ? '' : params.params_transigner_prefilter
    def params_transigner_em        = (params.params_transigner_em == true) ? '' : params.params_transigner_em
