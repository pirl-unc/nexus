...
// ------------------------------------------------------------
include { runRatatoskCorrectFirstPass }     from '../../../tools/ratatosk'
include { runRatatoskCorrectSecondPass }    from '../../../tools/ratatosk'
...
// ------------------------------------------------------------
workflow READ_ERROR_CORRECTION_RATATOSK {
    take:
...
workflow {
    ...
    if (params.help) {
        ...
        usage: nexus run --nf-workflow read_error_correction_ratatosk.nf [required] [optional] [--help]
    ...
    def params_ratatosk_first_correct  = (params.params_ratatosk_first_correct == true) ? '' : params.params_ratatosk_first_correct
    def params_ratatosk_second_correct = (params.params_ratatosk_second_correct == true) ? '' : params.params_ratatosk_second_correct
    ...
    READ_ERROR_CORRECTION_RATATOSK(
        input_fastq_files_ch,
        params_ratatosk_first_correct,
        params_ratatosk_second_correct,
        params.output_dir
