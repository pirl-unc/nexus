## antigen_prediction_mhcflurry2.nf
...
### Example
```
nexus run --nf-workflow antigen_prediction_mhcflurry2.nf \
...
Each `csv_file` should have the following columns: `peptide` and `allele`.
