## antigen_prediction_mhcflurry2-scan.nf
...
### Example
```
nexus run --nf-workflow antigen_prediction_mhcflurry2-scan.nf \
...
|-----------|-------------------------------------------|
| sample_id | Sample ID.                                |
| csv_file  | Full path to MHCflurry2 input `csv` file. |

Each `csv_file` should have the following columns: `sequence_id` and `sequence`.
