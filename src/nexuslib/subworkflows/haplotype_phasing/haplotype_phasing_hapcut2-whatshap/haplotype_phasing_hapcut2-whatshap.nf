 ...
 * one call (parallel to the merged HAPLOTYPE_PHASING_WHATSHAP design).
 */
...
// ------------------------------------------------------------
workflow HAPLOTYPE_PHASING_HAPCUT2_WHATSHAP {
    take:
...
workflow {
    ...
    if (params.help) {
        ...
        usage: nexus run --nf-workflow haplotype_phasing_hapcut2-whatshap.nf [required] [optional] [--help]
    ...
    HAPLOTYPE_PHASING_HAPCUT2_WHATSHAP(
        input_bam_vcf_files_ch,
        params.reference_genome_fasta_file,
