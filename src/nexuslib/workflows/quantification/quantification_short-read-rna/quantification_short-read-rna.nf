...
if (params.help) {
    log.info """\
    usage: nexus run --nf-workflow quantification_short-read-rna.nf -params-file params.yaml [--help]
...
// ------------------------------------------------------------
workflow QUANTIFICATION_SHORTREAD_RNA {
    take:
