...
if (params.help) {
    log.info """\
    usage: nexus run --nf-workflow quantification_long-read-rna.nf -params-file params.yaml [--help]
...
// ------------------------------------------------------------
workflow QUANTIFICATION_LONGREAD_RNA {
    take:
