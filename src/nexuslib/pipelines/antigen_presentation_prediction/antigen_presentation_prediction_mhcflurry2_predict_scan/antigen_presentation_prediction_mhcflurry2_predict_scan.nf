...
include { runMhcflurry2PredictScan } from '../../modules/mhcflurry2'
...
// Step 5. Workflow
workflow ANTIGEN_PRESENTATION_PREDICTION_MHCFLURRY2_PREDICT_SCAN {
    take:
...
workflow {
    ANTIGEN_PRESENTATION_PREDICTION_MHCFLURRY2_PREDICT_SCAN(
        input_mhcflurry2_csv_files_ch,
        params.alleles,
        params_mhcflurry2_predict_scan,
        params.output_dir
