...
include { runMhcflurry2Predict } from '../../modules/mhcflurry2'
...
if (params.help) {
    ...
    usage: nexus run --nf-workflow antigen_presentation_prediction_mhcflurry2_predict.nf [required] [optional] [--help]
...
// Step 5. Workflow
workflow ANTIGEN_PRESENTATION_PREDICTION_MHCFLURRY2_PREDICT {
    take:
...
workflow {
    ANTIGEN_PRESENTATION_PREDICTION_MHCFLURRY2_PREDICT(
        input_mhcflurry2_csv_files_ch,
        params_mhcflurry2_predict,
        params.output_dir
    )
