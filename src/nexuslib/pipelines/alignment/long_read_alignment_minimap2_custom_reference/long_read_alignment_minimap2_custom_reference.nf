...
include { runMinimap2CustomReference } from '../../modules/minimap2'
include { runSamtoolsSamToBamCustomReference } from '../../modules/samtools'
include { runSamtoolsCalmdCustomReference } from '../../modules/samtools'
include { runSamtoolsSortCustomReference } from '../../modules/samtools'
...
if (params.help) {
    ...
    usage: nexus run --nf-workflow long_read_alignment_custom_reference_minimap2.nf [required] [optional] [--help]
...
// Step 5. Workflow
workflow LONG_READ_ALIGNMENT_CUSTOM_REFERENCE_MINIMAP2 {
    take:
    ...
    main:
        ...
        runSamtoolsSamToBamCustomReference(
            runMinimap2CustomReference.out.f
        )
        runSamtoolsCalmdCustomReference(
            runSamtoolsSamToBamCustomReference.out.f
        )
        runSamtoolsSortCustomReference(
            runSamtoolsCalmdCustomReference.out.f
        )
...
workflow {
    LONG_READ_ALIGNMENT_CUSTOM_REFERENCE_MINIMAP2(
