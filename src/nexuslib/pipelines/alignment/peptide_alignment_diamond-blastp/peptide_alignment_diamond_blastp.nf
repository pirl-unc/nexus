...
include { runDiamondBlastp } from '../../modules/diamond'
...
params.output_dir = ''
// Optional arguments
params.database_file = '/datastore/lbcfs/collaborations/pirl/seqdata/tool-resources/diamond/nr.dmnd'
...
if (params.help) {
    ...
    optional arguments:
        --database_file                     :   Diamond-prepared local Blast database file (default: /datastore/lbcfs/collaborations/pirl/seqdata/tool-resources/diamond/nr.dmnd).
...
// Step 5. Workflow
workflow PEPTIDE_ALIGNMENT_DIAMOND_BLASTP {
    take:
...
workflow {
    PEPTIDE_ALIGNMENT_DIAMOND_BLASTP(
        input_fasta_files_ch,
