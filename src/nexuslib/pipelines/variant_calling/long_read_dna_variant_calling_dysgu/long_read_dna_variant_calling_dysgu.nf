...
params.params_dysgu_run = '--mode pacbio --min-support 3 --min-size 30 --mq 20'
...
log.info """\
         ======================================================================================
         Identify somatic structural variants in long-read DNA sequencing BAM files using Dysgu
         ======================================================================================
         """.stripIndent()
...
// Step 5. Workflow
workflow LONG_READ_DNA_VARIANT_CALLING_DYSGU {
    take:
...
workflow {
    LONG_READ_DNA_VARIANT_CALLING_DYSGU(
        input_bam_files_ch,
