...
include { runKallistoQuantSingleEndReads } from '../../modules/kallisto'
...
params.params_kallisto_quant_fragment_length = ''
params.params_kallisto_quant_sd = ''
// Optional arguments
...
if (params.help) {
    ...
    log.info"""\
        ...
        params_kallisto_quant_fragment_length   :   ${params.params_kallisto_quant_fragment_length}
        params_kallisto_quant_sd                :   ${params.params_kallisto_quant_sd}
...
workflow LONG_READ_RNA_QUANTIFICATION_KALLISTO {
    take:
        ...
        output_dir
    main:
        runKallistoQuantSingleEndReads(
            input_fastq_files_ch,
            kallisto_index_file,
            params_kallisto_quant_fragment_length,
            params_kallisto_quant_sd,
    ...
    emit:
        runKallistoQuantSingleEndReads.out.f
}
