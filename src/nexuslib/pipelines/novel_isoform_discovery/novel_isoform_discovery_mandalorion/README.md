## novel_isoform_discovery_mandalorion.nf

Discovers novel isoforms using [Mandalorion](https://github.com/christopher-vollmers/Mandalorion).
...
```
nexus run --nf-workflow novel_isoform_discovery_mandalorion.nf \
