...
include { runSqanti3FastqMode } from '../../modules/sqanti3'
...
params.params_sqanti3_qc = '--aligner_choice minimap2 --report html --force_id_ignore --isoAnnotLite'
...
log.info """\
         ==================================================
         Discover novel isoforms using Sqanti3 (FASTQ mode)
         ==================================================
         """.stripIndent()
...
// Step 4. Workflow
workflow NOVEL_ISOFORM_DISCOVERY_SQANTI3_FASTQ_MODE {
    take:
    ...
    emit:
        runSqanti3FastqMode.out.f
}

workflow {
    NOVEL_ISOFORM_DISCOVERY_SQANTI3_FASTQ_MODE(
        input_fastq_files_ch,
