...
params.flair = 'flair'
params.flair_align_params = ''
params.flair_correct_params = ''
params.flair_collapse_params = ''
params.delete_work_dir = false

// Step 3. Print inputs and help
log.info """\
         ========================================
         Long-read RNA quantification using FLAIR
         ========================================
         """.stripIndent()
...
if (params.help) {
    ...
    log.info"""\
        ...
        flair                           :   ${params.flair}
        flair_align_params              :   ${params.flair_align_params}
        flair_correct_params            :   ${params.flair_correct_params}
        flair_collapse_params           :   ${params.flair_collapse_params}
...
workflow NOVEL_ISOFORM_DISCOVERY_FLAIR {
    take:
        ...
        flair
        flair_align_params
        flair_correct_params
        flair_collapse_params
        output_dir
    main:
