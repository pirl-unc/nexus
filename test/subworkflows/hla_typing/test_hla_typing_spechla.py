...
def test_hla_typing_spechla():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_hla_typing_spechla'
    work_dir = temp_dir + '/work/test_hla_typing_spechla'
    output_dir = temp_dir + '/outputs/test_hla_typing_spechla'
    ...
    run_workflow(workflow='hla_typing_spechla.nf',
                 nextflow='nextflow',
