...
def test_hla_typing_seq2hla():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_hla_typing_seq2hla'
    work_dir = temp_dir + '/work/test_hla_typing_seq2hla'
    output_dir = temp_dir + '/outputs/test_hla_typing_seq2hla'
    ...
    run_workflow(workflow='hla_typing_seq2hla.nf',
                 nextflow='nextflow',
