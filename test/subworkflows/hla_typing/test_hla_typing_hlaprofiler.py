...
def test_hla_typing_hlaprofiler():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_hla_typing_hlaprofiler'
    work_dir = temp_dir + '/work/test_hla_typing_hlaprofiler'
    output_dir = temp_dir + '/outputs/test_hla_typing_hlaprofiler'
    ...
    run_workflow(workflow='hla_typing_hlaprofiler.nf',
                 nextflow='nextflow',
