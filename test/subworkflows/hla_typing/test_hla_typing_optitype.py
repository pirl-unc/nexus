...
def test_hla_typing_optitype():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_hla_typing_optitype'
    work_dir = temp_dir + '/work/test_hla_typing_optitype'
    output_dir = temp_dir + '/outputs/test_hla_typing_optitype'
    ...
    run_workflow(workflow='hla_typing_optitype.nf',
                 nextflow='nextflow',
