...
def test_variant_calling_pbsv():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_pbsv'
    work_dir = temp_dir + '/work/test_variant_calling_pbsv'
    output_dir = temp_dir + '/outputs/test_variant_calling_pbsv'
    ...
    run_workflow(workflow='variant_calling_pbsv.nf',
                 nextflow='nextflow',
