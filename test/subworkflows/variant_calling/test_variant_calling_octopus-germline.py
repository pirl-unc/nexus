...
def test_variant_calling_octopus_germline():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_octopus_germline'
    work_dir = temp_dir + '/work/test_variant_calling_octopus_germline'
    output_dir = temp_dir + '/outputs/test_variant_calling_octopus_germline'
    ...
    run_workflow(workflow='variant_calling_octopus-germline.nf',
                 nextflow='nextflow',
