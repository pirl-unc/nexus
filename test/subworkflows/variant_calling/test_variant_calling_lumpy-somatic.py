...
def test_variant_calling_lumpy_somatic():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_lumpy_somatic'
    work_dir = temp_dir + '/work/test_variant_calling_lumpy_somatic'
    output_dir = temp_dir + '/outputs/test_variant_calling_lumpy_somatic'
    ...
    run_workflow(workflow='variant_calling_lumpy-somatic.nf',
                 nextflow='nextflow',
