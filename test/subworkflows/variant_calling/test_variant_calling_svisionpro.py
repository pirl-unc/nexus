...
def test_variant_calling_svisionpro():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_svisionpro'
    work_dir = temp_dir + '/work/test_variant_calling_svisionpro'
    output_dir = temp_dir + '/outputs/test_variant_calling_svisionpro'
    ...
    workflow_args = [
        ...
        '--params_svisionpro', '"--detect_mode somatic --preset hifi --min_supp 3 --min_mapq 20 --min_sv_size 10 --max_sv_size 1000000 --device cpu"',
        '--params_svisionpro_extract', '"--extract somatic --min_supp 3"',
        '--output_dir', output_dir,
    ]
    run_workflow(workflow='variant_calling_svisionpro.nf',
                 nextflow='nextflow',
