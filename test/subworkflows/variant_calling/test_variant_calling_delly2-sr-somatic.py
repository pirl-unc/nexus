...
def test_variant_calling_delly2_sr_somatic():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_delly2_sr_somatic'
    work_dir = temp_dir + '/work/test_variant_calling_delly2_sr_somatic'
    output_dir = temp_dir + '/outputs/test_variant_calling_delly2_sr_somatic'
    ...
    run_workflow(workflow='variant_calling_delly2-sr-somatic.nf',
                 nextflow='nextflow',
