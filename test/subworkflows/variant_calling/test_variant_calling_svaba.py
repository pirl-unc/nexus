...
def test_variant_calling_svaba():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_svaba'
    work_dir = temp_dir + '/work/test_variant_calling_svaba'
    output_dir = temp_dir + '/outputs/test_variant_calling_svaba'
    ...
    run_workflow(workflow='variant_calling_svaba.nf',
                 nextflow='nextflow',
