...
def test_variant_calling_manta_somatic():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_manta_somatic'
    work_dir = temp_dir + '/work/test_variant_calling_manta_somatic'
    output_dir = temp_dir + '/outputs/test_variant_calling_manta_somatic'
    ...
    run_workflow(workflow='variant_calling_manta-somatic.nf',
                 nextflow='nextflow',
