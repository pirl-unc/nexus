...
def test_variant_calling_svim():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_svim'
    work_dir = temp_dir + '/work/test_variant_calling_svim'
    output_dir = temp_dir + '/outputs/test_variant_calling_svim'
    ...
    run_workflow(workflow='variant_calling_svim.nf',
                 nextflow='nextflow',
