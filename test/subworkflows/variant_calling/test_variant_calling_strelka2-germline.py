...
def test_variant_calling_strelka2_germline():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_strelka2_germline'
    work_dir = temp_dir + '/work/test_variant_calling_strelka2_germline'
    output_dir = temp_dir + '/outputs/test_variant_calling_strelka2_germline'
    ...
    run_workflow(workflow='variant_calling_strelka2-germline.nf',
                 nextflow='nextflow',
