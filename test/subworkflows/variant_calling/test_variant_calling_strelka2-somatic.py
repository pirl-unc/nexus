...
def test_variant_calling_strelka2_somatic():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_strelka2'
    work_dir = temp_dir + '/work/test_variant_calling_strelka2'
    output_dir = temp_dir + '/outputs/test_variant_calling_strelka2'
    ...
    run_workflow(workflow='variant_calling_strelka2-somatic.nf',
                 nextflow='nextflow',
