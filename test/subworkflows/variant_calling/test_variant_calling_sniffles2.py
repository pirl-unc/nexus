...
def test_variant_calling_sniffles2():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_sniffles2'
    work_dir = temp_dir + '/work/test_variant_calling_sniffles2'
    output_dir = temp_dir + '/outputs/test_variant_calling_sniffles2'
    ...
    run_workflow(workflow='variant_calling_sniffles2.nf',
                 nextflow='nextflow',
