...
def test_variant_calling_haplotypecaller():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_calling_haplotypecaller'
    work_dir = temp_dir + '/work/test_variant_calling_haplotypecaller'
    output_dir = temp_dir + '/outputs/test_variant_calling_haplotypecaller'
    ...
    run_workflow(workflow='variant_calling_haplotypecaller.nf',
                 nextflow='nextflow',
