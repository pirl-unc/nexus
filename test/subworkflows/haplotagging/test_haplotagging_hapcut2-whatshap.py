...
def test_haplotagging_hapcut2_whatshap():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_haplotagging_hapcut2_whatshap'
    work_dir = temp_dir + '/work/test_haplotagging_hapcut2_whatshap'
    output_dir = temp_dir + '/outputs/test_haplotagging_hapcut2_whatshap'
    ...
    run_workflow(workflow='haplotagging_hapcut2-whatshap.nf',
                 nextflow='nextflow',
