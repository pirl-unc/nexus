...
def test_haplotagging_longcallr():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_haplotagging_longcallr'
    work_dir = temp_dir + '/work/test_haplotagging_longcallr'
    output_dir = temp_dir + '/outputs/test_haplotagging_longcallr'
