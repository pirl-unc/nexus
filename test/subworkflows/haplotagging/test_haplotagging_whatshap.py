...
def test_haplotagging_whatshap():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_haplotagging_whatshap'
    work_dir = temp_dir + '/work/test_haplotagging_whatshap'
    output_dir = temp_dir + '/outputs/test_haplotagging_whatshap'
    ...
    run_workflow(workflow='haplotagging_whatshap.nf',
                 nextflow='nextflow',
