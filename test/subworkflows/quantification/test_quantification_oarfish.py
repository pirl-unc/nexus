...
def test_quantification_oarfish():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_quantification_oarfish'
    work_dir = temp_dir + '/work/test_quantification_oarfish'
    output_dir = temp_dir + '/outputs/test_quantification_oarfish'
    ...
    run_workflow(workflow='quantification_oarfish.nf',
                 nextflow='nextflow',
