...
def test_quantification_transigner():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_quantification_transigner'
    work_dir = temp_dir + '/work/test_quantification_transigner'
    output_dir = temp_dir + '/outputs/test_quantification_transigner'
    ...
    run_workflow(workflow='quantification_transigner.nf',
                 nextflow='nextflow',
