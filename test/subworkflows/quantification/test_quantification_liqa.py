...
def test_quantification_liqa():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_quantification_liqa'
    work_dir = temp_dir + '/work/test_quantification_liqa'
    output_dir = temp_dir + '/outputs/test_quantification_liqa'
    ...
    run_workflow(workflow='quantification_liqa.nf',
                 nextflow='nextflow',
