...
def test_quantification_kallisto_pe():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_quantification_kallisto_pe'
    work_dir = temp_dir + '/work/test_quantification_kallisto_pe'
    output_dir = temp_dir + '/outputs/test_quantification_kallisto_pe'
    ...
    run_workflow(workflow='quantification_kallisto-pe.nf',
                 nextflow='nextflow',
