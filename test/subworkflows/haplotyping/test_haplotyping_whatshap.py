...
def test_haplotyping_whatshap():
    ...
    phased_small_variants_vcf_gz_file = get_data_path(name='vcf/nexus-dna-001-tumor_whatshap_phased.vcf.gz')
    phased_small_variants_vcf_gz_tbi_file = get_data_path(name='vcf/nexus-dna-001-tumor_whatshap_phased.vcf.gz.tbi')
    reference_genome_fasta_file = get_data_path(name='fasta/GRCh38.p14.genome.chr17.fa.gz')
    temp_dir = os.getcwd() + '/tmp'
    intermediate_dir = temp_dir + '/intermediate/test_haplotyping_whatshap'
    work_dir = temp_dir + '/work/test_haplotyping_whatshap'
    output_dir = temp_dir + '/outputs/test_haplotyping_whatshap'
    ...
    run_workflow(workflow='haplotyping_whatshap.nf',
                 nextflow='nextflow',
