...
def test_haplotype_phasing_longcallr():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_haplotype_phasing_longcallr'
    work_dir = temp_dir + '/work/test_haplotype_phasing_longcallr'
    output_dir = temp_dir + '/outputs/test_haplotype_phasing_longcallr'
    ...
    run_workflow(workflow='haplotype_phasing_longcallr.nf',
                 nextflow='nextflow',
