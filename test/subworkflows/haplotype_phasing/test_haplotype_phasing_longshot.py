...
def test_haplotype_phasing_longshot():
    """End-to-end test for the standalone Longshot haplotype-phasing subworkflow.
    ...
    intermediate_dir = temp_dir + '/intermediate/test_haplotype_phasing_longshot'
    work_dir = temp_dir + '/work/test_haplotype_phasing_longshot'
    output_dir = temp_dir + '/outputs/test_haplotype_phasing_longshot'
    ...
    run_workflow(workflow='haplotype_phasing_longshot.nf',
                 nextflow='nextflow',
