...
def test_assembly_stringtie2():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_assembly_stringtie2'
    work_dir = temp_dir + '/work/test_assembly_stringtie2'
    output_dir = temp_dir + '/outputs/test_assembly_stringtie2'
    ...
    run_workflow(workflow='assembly_stringtie2.nf',
                 nextflow='nextflow',
