...
def test_assembly_trinity():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_assembly_trinity'
    work_dir = temp_dir + '/work/test_assembly_trinity'
    output_dir = temp_dir + '/outputs/test_assembly_trinity'
    ...
    run_workflow(workflow='assembly_trinity.nf',
                 nextflow='nextflow',
