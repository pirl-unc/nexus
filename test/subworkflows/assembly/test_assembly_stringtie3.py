...
def test_assembly_stringtie3():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_assembly_stringtie3'
    work_dir = temp_dir + '/work/test_assembly_stringtie3'
    output_dir = temp_dir + '/outputs/test_assembly_stringtie3'
    ...
    run_workflow(workflow='assembly_stringtie3.nf',
                 nextflow='nextflow',
