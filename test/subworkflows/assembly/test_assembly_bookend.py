...
def test_assembly_bookend_1():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_assembly_bookend_1'
    work_dir = temp_dir + '/work/test_assembly_bookend_1'
    output_dir = temp_dir + '/outputs/test_assembly_bookend_1'
    ...
    run_workflow(workflow='assembly_bookend.nf',
                 nextflow='nextflow',
                 workflow_args=workflow_args)


def test_assembly_bookend_2():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    ...
    reference_genome_fasta_file = get_data_path(name='fasta/GRCh38.p14.genome.chr17.fa.gz')
    temp_dir = os.getcwd() + '/tmp'
    intermediate_dir = temp_dir + '/intermediate/test_assembly_bookend_2'
    work_dir = temp_dir + '/work/test_assembly_bookend_2'
    output_dir = temp_dir + '/outputs/test_assembly_bookend_2'
    if not os.path.exists(intermediate_dir):
        os.makedirs(intermediate_dir)
    if not os.path.exists(work_dir):
        os.makedirs(work_dir)
