...
def test_read_error_correction_ratatosk():
    ...
    long_read_tumor_dna_fastq_file = get_data_path(name='fastq/nexus-dna-001-tumor_long_read.fastq.gz')
    short_read_tumor_dna_fastq_r1_file = get_data_path(name='fastq/nexus-dna-001-tumor_paired-end_read_r1.fastq.gz')
    short_read_tumor_dna_fastq_r2_file = get_data_path(name='fastq/nexus-dna-001-tumor_paired-end_read_r2.fastq.gz')
    ...
    run_workflow(workflow='read_error_correction_ratatosk.nf',
                 nextflow='nextflow',
