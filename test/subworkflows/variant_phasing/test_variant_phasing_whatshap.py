...
def test_variant_phasing_whatshap():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_variant_phasing_whatshap'
    work_dir = temp_dir + '/work/test_variant_phasing_whatshap'
    output_dir = temp_dir + '/outputs/test_variant_phasing_whatshap'
    ...
    run_workflow(workflow='variant_phasing_whatshap.nf',
                 nextflow='nextflow',
