...
def test_paired_end_read_dna_somatic_small_variants_human_singularity():
    ...
    workflow_args = [
        ...
        '--containerization', 'singularity',
        '--deepvariant_bin_path', '/opt/deepvariant/bin/run_deepvariant',
        '--deepvariant_input_path', '/datastore/lbcfs/collaborations/pirl/members/jinseok/projects/nexus/',
        '--deepvariant_output_path', '/datastore/lbcfs/collaborations/pirl/members/jinseok/projects/nexus/',
        '--deepvariant_bin_version', '1.6.0',
        '--deepvariant_model_type', 'WGS',
        '--output_dir', output_dir,
        '-w', work_dir
