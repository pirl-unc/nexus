...
def test_long_read_dna_variant_calling_svim():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_long_read_dna_variant_calling_svim'
    work_dir = temp_dir + '/work/test_long_read_dna_variant_calling_svim'
    output_dir = temp_dir + '/outputs/test_long_read_dna_variant_calling_svim'
    ...
    run_workflow(workflow='long_read_dna_variant_calling_svim.nf',
                 nextflow='nextflow',
