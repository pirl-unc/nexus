...
def test_paired_end_read_dna_variant_calling_gridss():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_paired_end_read_dna_variant_calling_gridss'
    work_dir = temp_dir + '/work/test_paired_end_read_dna_variant_calling_gridss'
    output_dir = temp_dir + '/outputs/test_paired_end_read_dna_variant_calling_gridss'
    ...
    run_workflow(workflow='paired-end_read_dna_variant_calling_gridss.nf',
                 nextflow='nextflow',
