...
def test_long_read_dna_variant_calling_pbsv():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_long_read_dna_variant_calling_pbsv'
    work_dir = temp_dir + '/work/test_long_read_dna_variant_calling_pbsv'
    output_dir = temp_dir + '/outputs/test_long_read_dna_variant_calling_pbsv'
    ...
    run_workflow(workflow='long_read_dna_variant_calling_pbsv.nf',
                 nextflow='nextflow',
