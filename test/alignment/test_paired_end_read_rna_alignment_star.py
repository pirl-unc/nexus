...
def test_paired_end_read_rna_alignment_star():
    ...
    paired_end_read_tumor_rna_r1_fastq_file = get_data_path(name='fastq/hg38_tp53_tumor_paired-end_read_rna.r1.fastq.gz')
    paired_end_read_tumor_rna_r2_fastq_file = get_data_path(name='fastq/hg38_tp53_tumor_paired-end_read_rna.r2.fastq.gz')
