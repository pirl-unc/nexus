#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/manta-1.6.0.centos6_x86_64/bin/configManta.py --tumorBam sample100tumor_fixmate_markeddup_recalibrated.bam --normalBam sample100normal_fixmate_markeddup_recalibrated.bam --referenceFasta hg38_chr17_1-8M.fa --runDir sample100tumor_manta_outputs/'
#
...
main(r"/Users/leework/Documents/Research/projects/project_nexus/data/processed/work/paired-end_read_dna_variant_calling_manta/22/1cc811f41d3c10477372f91e967589/sample100tumor_manta_outputs/runWorkflow.py.config.pickle","manta",MantaWorkflow)
