#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/manta-1.6.0.centos6_x86_64/bin/configManta.py --tumorBam nexus-dna-003-tumor-paired-end-read_fixmate_markeddup_recalibrated.bam --normalBam nexus-dna-003-normal-paired-end-read_fixmate_markeddup_recalibrated.bam --referenceFasta GRCh38.p14.genome.chr17_1-8M.fa --runDir nexus-dna-003-tumor_manta_outputs/'
#
...
sys.path.append(r'/manta-1.6.0.centos6_x86_64/lib/python')
...
main(r"/Users/leework/Documents/Research/projects/project_nexus/data/processed/work/variant_calling_manta/35/8be3399f55030627caa4393b7702d8/nexus-dna-003-tumor_manta_outputs/runWorkflow.py.config.pickle","manta",MantaWorkflow)
