...
def test_long_read_dna_variant_phasing_hiphase():
    ...
    long_read_tumor_dna_bam_file = get_data_path(name='bam/sample001normal_minimap2_mdtagged_sorted.bam')
    long_read_tumor_dna_bam_bai_file = get_data_path(name='bam/sample001normal_minimap2_mdtagged_sorted.bam.bai')
    small_variants_vcf_gz_file = get_data_path(name='vcf/sample001normal_whatshap_phased.vcf.gz')
    small_variants_vcf_gz_tbi_file = get_data_path(name='vcf/sample001normal_whatshap_phased.vcf.gz.tbi')
    structural_variants_vcf_gz_file =get_data_path(name='vcf/sample001normal_pbsv.vcf.gz')
    structural_variants_vcf_gz_tbi_file =get_data_path(name='vcf/sample001normal_pbsv.vcf.gz.tbi')
