...
def test_long_read_dna_haplotyping_whatshap():
    ...
    phased_small_variants_vcf_gz_file = get_data_path(name='vcf/sample001normal_whatshap_phased.vcf.gz')
    phased_small_variants_vcf_gz_tbi_file = get_data_path(name='vcf/sample001normal_whatshap_phased.vcf.gz.tbi')
