...
def test_long_read_dna_small_variants():
    ...
    workflow_args = [
        ...
        '--deepvariant_lib_path', '/home/runner/work/nexus/nexus/',
    ...
    #     '--deepvariant_bin_path', '/opt/deepvariant/bin/run_deepvariant',
    #     '--deepvariant_lib_path', '/Users/leework/Documents/Research/projects/nexus/',
