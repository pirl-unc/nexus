...
def test_novel_isoform_discovery_isotools():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_novel_isoform_discovery_isotools'
    work_dir = temp_dir + '/work/test_novel_isoform_discovery_isotools'
    output_dir = temp_dir + '/outputs/test_novel_isoform_discovery_isotools'
    ...
    run_workflow(workflow='novel_isoform_discovery_isotools.nf',
                 nextflow='nextflow',
