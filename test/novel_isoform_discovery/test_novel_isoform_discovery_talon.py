...
def test_novel_isoform_discovery_talon():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_novel_isoform_discovery_talon'
    work_dir = temp_dir + '/work/test_novel_isoform_discovery_talon'
    output_dir = temp_dir + '/outputs/test_novel_isoform_discovery_talon'
    ...
    run_workflow(workflow='novel_isoform_discovery_talon.nf',
                 nextflow='nextflow',
