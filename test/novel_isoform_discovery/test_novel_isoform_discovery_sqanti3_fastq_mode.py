...
def test_novel_isoform_discovery_sqanti3_fastq_mode():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    long_read_tumor_rna_fastq_file = get_data_path(name='fastq/sample200tumor_long_read_rna.fastq')
    ...
    intermediate_dir = temp_dir + '/intermediate/test_novel_isoform_discovery_sqanti3_fastq_mode'
    work_dir = temp_dir + '/work/test_novel_isoform_discovery_sqanti3_fastq_mode'
    output_dir = temp_dir + '/outputs/test_novel_isoform_discovery_sqanti3_fastq_mode'
    ...
    run_workflow(workflow='novel_isoform_discovery_sqanti3_fastq_mode.nf',
                 nextflow='nextflow',
