...
# arcasHLA, HLAProfiler, seq2HLA, OptiType (nexus-rna-104-normal)
def test_hla_typing_shortread_rna():
    ...
    params_yaml_file = get_data_path(name='inputs/workflows/hla_typing_short-read-rna/params_1.yaml')
    temp_dir = os.getcwd() + '/tmp'
    intermediate_dir = temp_dir + '/intermediate/test_hla_typing_shortread_rna'
    work_dir = temp_dir + '/work/test_hla_typing_shortread_rna'
    output_dir = temp_dir + '/outputs/test_hla_typing_shortread_rna'
    ...
    run_workflow(workflow='hla_typing_short-read-rna.nf',
                 nextflow='nextflow',
