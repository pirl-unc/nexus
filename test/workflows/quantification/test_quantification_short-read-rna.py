...
def test_quantification_short_read_rna():
    ...
    intermediate_dir = temp_dir + '/intermediate/test_quantification_short_read_rna'
    work_dir = temp_dir + '/work/test_quantification_short_read_rna'
    output_dir = temp_dir + '/outputs/test_quantification_short_read_rna'
    ...
    run_workflow(workflow='quantification_short-read-rna.nf',
                 nextflow='nextflow',
