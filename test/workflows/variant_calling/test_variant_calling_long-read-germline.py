...
def test_variant_calling_long_read_germline_1():
    ...
    params_yaml_file = get_data_path(name='inputs/workflows/variant_calling_long-read-germline/params_1.yaml')
    ...
    run_workflow(workflow='variant_calling_long-read-germline.nf',
                 nextflow='nextflow',
                 workflow_args=workflow_args)


# CuteSV, Delly2, Dysgu, PBSV, Sniffles2, SVIM (SV callers — nexus-dna-004-tumor)
def test_variant_calling_long_read_germline_2():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    ...
    reference_genome_fasta_file = get_data_path(name='fasta/GRCh38.p14.genome.chr17.fa.gz')
    params_yaml_file = get_data_path(name='inputs/workflows/variant_calling_long-read-germline/params_2.yaml')
...
def test_variant_calling_long_read_germline_github_3():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    ...
    params_yaml_file = get_data_path(name='inputs/workflows/variant_calling_long-read-germline/params_3.yaml')
    temp_dir = os.getcwd() + '/tmp'
...
# DeepVariant + HiFiCNV (nexus-dna-001-tumor)
def test_variant_calling_long_read_germline_local_3():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    bam_file = get_data_path(name='bam/nexus-dna-005-tumor-long-read_minimap2_mdtagged_sorted.bam')
    bam_bai_file = get_data_path(name='bam/nexus-dna-005-tumor-long-read_minimap2_mdtagged_sorted.bam.bai')
    reference_genome_fasta_file = get_data_path(name='fasta/GRCh38.p14.genome.chr21-22.fa.gz')
