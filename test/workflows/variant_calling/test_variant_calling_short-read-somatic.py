...
def test_variant_calling_short_read_somatic_github_1():
    ...
    params_yaml_file = get_data_path(name='inputs/workflows/variant_calling_short-read-somatic/params_1.yaml')
    ...
    pd.DataFrame({
        ...
        'tumor_bam_file_no_abra2': [tumor_bam_file],
        'tumor_bam_bai_file_no_abra2': [tumor_bam_bai_file],
        'normal_bam_file_no_abra2': [normal_bam_file],
        'normal_bam_bai_file_no_abra2': [normal_bam_bai_file],
    ...
    run_workflow(workflow='variant_calling_short-read-somatic.nf',
                 nextflow='nextflow',
                 workflow_args=workflow_args)


# ClairS, Deepsomatic, Delly2, GRIDSS, Mutect2, Lumpy, Strelka2, Svaba
def test_variant_calling_short_read_somatic_local_1():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    tumor_bam_file = get_data_path(name='bam/nexus-dna-002-tumor-paired-end-read_fixmate_markeddup_recalibrated.bam')
    tumor_bam_bai_file = get_data_path(name='bam/nexus-dna-002-tumor-paired-end-read_fixmate_markeddup_recalibrated.bam.bai')
    normal_bam_file = get_data_path(name='bam/nexus-dna-002-normal-paired-end-read_fixmate_markeddup_recalibrated.bam')
...
# Dysgu
def test_variant_calling_short_read_somatic_2():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    tumor_bam_file = get_data_path(name='bam/nexus-dna-002-tumor-paired-end-read_fixmate_markeddup_recalibrated.bam')
    tumor_bam_bai_file = get_data_path(name='bam/nexus-dna-002-tumor-paired-end-read_fixmate_markeddup_recalibrated.bam.bai')
...
# Manta
def test_variant_calling_short_read_somatic_3():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    tumor_bam_file = get_data_path(name='bam/nexus-dna-002-tumor-paired-end-read_fixmate_markeddup_recalibrated.bam')
    tumor_bam_bai_file = get_data_path(name='bam/nexus-dna-002-tumor-paired-end-read_fixmate_markeddup_recalibrated.bam.bai')
    normal_bam_file = get_data_path(name='bam/nexus-dna-002-normal-paired-end-read_fixmate_markeddup_recalibrated.bam')
...
# Seqeunza
def test_variant_calling_short_read_somatic_4():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
