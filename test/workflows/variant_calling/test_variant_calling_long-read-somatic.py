...
def test_variant_calling_long_read_somatic_github_1():
    ...
    params_yaml_file = get_data_path(name='inputs/workflows/variant_calling_long-read-somatic/params_1.yaml')
    ...
    run_workflow(workflow='variant_calling_long-read-somatic.nf',
                 nextflow='nextflow',
                 workflow_args=workflow_args)


# ClairS, DeepSomatic (SNV/indel callers — nexus-dna-001 tumor/normal)
def test_variant_calling_long_read_somatic_local_1():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    tumor_bam_file = get_data_path(name='bam/nexus-dna-001-tumor-long-read_minimap2_mdtagged_sorted.bam')
    tumor_bam_bai_file = get_data_path(name='bam/nexus-dna-001-tumor-long-read_minimap2_mdtagged_sorted.bam.bai')
    normal_bam_file = get_data_path(name='bam/nexus-dna-001-normal-long-read_minimap2_mdtagged_sorted.bam')
...
def test_variant_calling_long_read_somatic_2():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    ...
    params_yaml_file = get_data_path(name='inputs/workflows/variant_calling_long-read-somatic/params_2.yaml')
...
def test_variant_calling_long_read_somatic_3():
    nextflow_config_file = get_data_path(name='nextflow/nextflow_test_docker.config')
    ...
    reference_genome_fasta_file = get_data_path(name='fasta/GRCh38.p14.genome.chr17.fa.gz')
    params_yaml_file = get_data_path(name='inputs/workflows/variant_calling_long-read-somatic/params_3.yaml')
