...
def test_docker_paired_end_read_rna_hla_typing_seq2hla():
    ...
    fastq_file_1 = get_data_path(name='fastq/hg38_hla-abc_paired_end_read_rna.r1.fastq.gz')
    fastq_file_2 = get_data_path(name='fastq/hg38_hla-abc_paired_end_read_rna.r2.fastq.gz')
