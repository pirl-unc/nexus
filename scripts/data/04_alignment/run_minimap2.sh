...
nexus run --nf-workflow alignment_minimap2.nf \
  ...
  -w /Users/ajslee/Documents/Research/projects/project_nexus/data/processed/work/alignment_minimap2/ \
  --samples_tsv_file /Users/ajslee/Documents/Research/projects/project_nexus/nexus/scripts/data/04_alignment/samples/samples_minimap2_5.tsv \
  --reference_genome_fasta_file /Users/ajslee/Documents/Research/projects/project_nexus/nexus/test/data/fasta/GRCh38.p14.genome.chr6.fa.gz \
  --params_minimap2 '"-ax map-hifi --cs --eqx -Y -L"' \
  --output_dir /Users/ajslee/Documents/Research/projects/project_nexus/nexus/test/data/bam/
