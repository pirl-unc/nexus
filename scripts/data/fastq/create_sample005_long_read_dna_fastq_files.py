...
if __name__ == "__main__":
    ...
    # Tandem duplication
    sequence_duplication = sequence_tp53[0:5000] + sequence_tp53[5000:6000] + sequence_tp53[5000:6000] + sequence_tp53[6000:]
    sequence_duplication = ''.join(sequence_duplication)
    sequence_tp53 = ''.join(sequence_tp53)
    sequence_ube2g1 = ''.join(sequence_ube2g1)

    create_fastq_file(
        sequences=[sequence_duplication, sequence_tp53, sequence_ube2g1],
        output_fastq_file='../../../test/data/fastq/sample005tumor_long_read_dna.fastq',
        num_reads=[60,60,60]
    )
    ...
    create_fastq_file(
        ...
        output_fastq_file='../../../test/data/fastq/sample005normal_long_read_dna.fastq',
        num_reads=[60,60]
    )
