...
if __name__ == "__main__":
    ...
    r1_file = open('../../../test/data/fastq/hg38_chr21-22_normal_paired_end_dna.r1.fastq', 'w')
    r2_file = open('../../../test/data/fastq/hg38_chr21-22_normal_paired_end_dna.r2.fastq', 'w')
    ...
    os.system('gzip ../../../test/data/fastq/hg38_chr21-22_normal_paired_end_dna.r1.fastq')
    os.system('gzip ../../../test/data/fastq/hg38_chr21-22_normal_paired_end_dna.r2.fastq')
