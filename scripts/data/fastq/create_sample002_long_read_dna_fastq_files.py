...
if __name__ == "__main__":
    ...
    # Translocation
    sequence_translocation = sequence_tp53[0:10000] + sequence_ube2g1[25000:]
    sequence_translocation = ''.join(sequence_translocation)
    sequence_tp53 = ''.join(sequence_tp53)
    sequence_ube2g1 = ''.join(sequence_ube2g1)

    create_fastq_file(
        sequences=[sequence_translocation, sequence_tp53, sequence_ube2g1],
        output_fastq_file='../../../test/data/fastq/sample002tumor_long_read_dna.fastq',
        num_reads=[60,60,60]
    )
    ...
    create_fastq_file(
        ...
        output_fastq_file='../../../test/data/fastq/sample002normal_long_read_dna.fastq',
        num_reads=[60,60,60]
    )
