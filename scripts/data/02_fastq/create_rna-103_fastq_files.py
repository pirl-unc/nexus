...
if __name__ == "__main__":
    ...
    for _,row in df_exons_fgf11.iterrows():
        ...
        if exon_number == 3: # intron retention (chr17:7441880-7441899)
            fgf11_tumor_sequence = fgf11_tumor_sequence + normal_sequence + 'GTGAGACAATGAGGCTGAGT'
        else:
    ...
    create_long_read_fastq_file(
        sequences=[fgf11_tumor_sequence, fgf11_normal_sequence],
        output_fastq_file='../../../test/data/fastq/nexus-rna-103-tumor_long_read.fastq.gz',
        num_reads=[10,10],
        read_length=20000,
        stranded=True
    )
    create_paired_end_fastq_files(
        sequences=[fgf11_tumor_sequence, fgf11_normal_sequence],
        output_r1_fastq_file='../../../test/data/fastq/nexus-rna-103-tumor_paired-end_read_r1.fastq.gz',
        output_r2_fastq_file = '../../../test/data/fastq/nexus-rna-103-tumor_paired-end_read_r2.fastq.gz',
        num_reads=[1000,1000],
        read_length=151,
        min_insert_size=300,
        max_insert_size=600
