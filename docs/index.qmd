...
```bash
nexus run --nf-workflow variant_calling_short-read-somatic.nf \
...
::: {.g-col-4}
### Workflows
Meta-workflows that orchestrate multiple subworkflows into end-to-end pipelines (e.g., `variant_calling_short-read-somatic`).
:::
