...
# Tests PacBio whole-genome sequencing alignment using minimap2.
...
SAMPLES_TSV_FILE=/datastore/lbcfs/collaborations/pirl/workflows/data/raw/metadata/human_pacbio_dna_fastq_files.tsv
...
WORK_DIR=/datastore/lbcfs/collaborations/pirl/workflows/data/processed/work/alignment/long_read_minimap2/pacbio_dna_minimap2/
OUTPUT_DIR=/datastore/lbcfs/collaborations/pirl/workflows/data/processed/alignment/long_read_minimap2/pacbio_dna_minimap2/
