...
# Tests PacBio RNA sequencing alignment using minimap2.
...
MINIMAP2_PARAMS="-ax splice:hq -uf \
                 --cs \
                 --eqx \
                 -Y \
                 -L"
...
WORK_DIR=/datastore/lbcfs/collaborations/pirl/workflows/data/processed/work/alignment/long_read_minimap2/pacbio_rna_minimap2/
OUTPUT_DIR=/datastore/lbcfs/collaborations/pirl/workflows/data/processed/alignment/long_read_minimap2/pacbio_rna_minimap2/
