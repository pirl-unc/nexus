...
# Exclude test_novel_isoform_discovery_isoquant because isoseq only runs on linux
pytest \
  -s \
  ...
  -k "not test_long_read_dna_small_variants_singularity and \
      ...
      not test_paired_end_read_dna_somatic_structural_variants and \
      not test_novel_isoform_discovery_isoquant"